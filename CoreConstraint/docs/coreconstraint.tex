...
Therefore, if the allocaitons are non int then the ceiling and floor of the allocations should be checked for satisfiability, and only if there is an allocation of these which is satisfiable should the problem be considered satisfiable.
